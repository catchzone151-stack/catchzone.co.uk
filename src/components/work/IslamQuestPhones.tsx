...
const RIGHT_SRC = "/assets/images/islamquest/fan-phones/right-boss-level.png";
  ...
  return (
    <div className={`relative mx-auto w-full max-w-[640px] ${className ?? ""}`}>
      ...
      <div className="relative flex items-end justify-center">
        <motion.div
          className="relative z-10 -mr-[10%] w-[34%] pb-[4%] sm:w-[36%]"
          style={{ filter: "drop-shadow(6px 10px 10px rgba(0,0,0,0.45))" }}
        ...
        <motion.div
          className="relative z-20 w-[44%] sm:w-[46%]"
          style={{ filter: "drop-shadow(0 14px 14px rgba(0,0,0,0.5))" }}
        ...
        <motion.div
          className="relative z-10 -ml-[10%] w-[34%] pb-[4%] sm:w-[36%]"
          style={{ filter: "drop-shadow(-6px 10px 10px rgba(0,0,0,0.45))" }}
          initial={reduced ? false : { x: -SIDE_TRAVEL, rotate: 0, opacity: 0 }}
          animate={{ x: 0, rotate: -SIDE_ROTATE, opacity: 1 }}
